...
xmlns="http://schemas.microsoft.com/winfx/2006/xaml/presentation"
        ...
        Title="Create NavUsers From File" Height="240" Width="300" ResizeMode="NoResize" WindowStartupLocation="CenterScreen" ShowInTaskbar="True">
        <Grid Background="{DynamicResource {x:Static SystemColors.WindowBrushKey}}" Height="240" VerticalAlignment="Center" HorizontalAlignment="Center" Width="300">
            <TextBox Name="txtUserFile" HorizontalAlignment="Left" Height="20" Width="230" Margin="27,31,0,0" Text="Select Username File List" VerticalAlignment="Top"  FontSize="11" IsReadOnly="true"/>
            <Label Name="lblsrvc" Content="Service Instance" HorizontalAlignment="Left" Margin="27,0,0,0" VerticalAlignment="Center"/>
            <ComboBox Name="cbxNavInstance" HorizontalAlignment="Left" Margin="118,0,0,0" VerticalAlignment="Center" Width="158" SelectedIndex="0"/>
            <Label Name="lblPermSet" Content="Permission Set" HorizontalAlignment="Left" Margin="27,133,0,0" VerticalAlignment="Top"/>
            <ComboBox Name="cbxPermissionSets" HorizontalAlignment="Left" Margin="118,135,0,0" VerticalAlignment="Top" Width="158" SelectedIndex="0"/>
            <Label Name="lblLicType" Content="License Type" HorizontalAlignment="Left" Margin="27,160,0,0" VerticalAlignment="Top"/>
            <ComboBox Name="cbxUsersLicenseTypes" HorizontalAlignment="Left" Margin="118,160,0,0" VerticalAlignment="Top" Width="158" SelectedIndex="0">
                <ComboBoxItem Content="Full"/>
                <ComboBoxItem Content="Limited"/>
            </ComboBox>
            <TextBox Name="txtPswdFile" HorizontalAlignment="Left" Height="20" Margin="27,56,0,0" Text="Directory To Export Password File" VerticalAlignment="Top" Width="231" FontSize="11" IsReadOnly="true"/>
            <Button Name="btnUserSourceFile" Content="..." Margin="256,31,0,0" VerticalAlignment="Top" Height="20" HorizontalAlignment="Left" Width="20"/>
            <Button Name="btnSavePswdFile" Content="..." HorizontalAlignment="Left" Margin="256,56,0,0" VerticalAlignment="Top" Width="20" Height="20"/>
            <Button Name="btnPerformAction" Content="Perform Action" Margin="0,196,0,0" VerticalAlignment="Top" Height="23" HorizontalAlignment="Center" Width="248"/>
            <ComboBox Name="cbxAuthType" HorizontalAlignment="Left" Margin="118,83,0,0" VerticalAlignment="Top" Width="158" SelectedIndex="0">
                <ComboBoxItem Content="Windows Authentication"/>
                <ComboBoxItem Content="NAV User Password"/>
            </ComboBox>
            <Label Name="lblAuthType" Content="Authentication " HorizontalAlignment="Left" Margin="27,83,0,0" VerticalAlignment="Top"/>
        </Grid>
</Window>
"@
